function onCreatePost()
	...
	makeLuaSprite('bg1', 'chavo/images/chavobg/Vecindad', -600, 200);
	addLuaSprite('bg1', false);
	makeAnimatedLuaSprite('back', 'chavo/images/chavobg/Quico_Background', -700, 200)
	addAnimationByPrefix('back', 'bounce','Quico_Background Idle', 15, true);
	addLuaSprite('back', false);
	makeAnimatedLuaSprite('gfb', 'chavo/images/chavobg/GF', 600, 800)
	addAnimationByPrefix('gfb', 'bounce','GF Idle', 15, true);
	addLuaSprite('gfb', false);


	makeLuaSprite('bg2', 'chavo/images/chavobg/VecindadPOV', -600, 200);
